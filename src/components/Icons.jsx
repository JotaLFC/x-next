...
export default function Icons({ id, uid }) {
  ...
  const { modalState, setModalState, setPostId } = useModalStore();
        ...
        <HiOutlineChat
          ...
          onClick={() => {
            if (!session) {
              ...
              setModalState(!modalState); // Use Zustand to toggle modal state
              setPostId(id); // Set the post ID in Zustand store
            }
          }}
        />
        {comments.length > 0 && (
